...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.productDo.UseModel(&domain.Product{})
	...
	_product.DeletedAt = field.NewTime(tableName, "deleted_at")
	_product.Name = field.NewString(tableName, "name")
	_product.Detail = field.NewString(tableName, "detail")
	_product.Price = field.NewFloat64(tableName, "price")
	_product.BasketProduct = productHasManyBasketProduct{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("BasketProduct", "domain.BasketProduct"),
	}

	_product.PromotionProduct = productHasManyPromotionProduct{
		db: db.Session(&gorm.Session{}),
...
type product struct {
	...
	Detail        field.String
	Price         field.Float64
	BasketProduct productHasManyBasketProduct

	PromotionProduct productHasManyPromotionProduct
...
type productHasManyBasketProduct struct {
	db *gorm.DB

	field.RelationField
}

func (a productHasManyBasketProduct) Where(conds ...field.Expr) *productHasManyBasketProduct {
	if len(conds) == 0 {
		return &a
	}
...
func (a productHasManyBasketProduct) WithContext(ctx context.Context) *productHasManyBasketProduct {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a productHasManyBasketProduct) Session(session *gorm.Session) *productHasManyBasketProduct {
	a.db = a.db.Session(session)
	return &a
}

func (a productHasManyBasketProduct) Model(m *domain.Product) *productHasManyBasketProductTx {
	return &productHasManyBasketProductTx{a.db.Model(m).Association(a.Name())}
}

type productHasManyBasketProductTx struct{ tx *gorm.Association }

func (a productHasManyBasketProductTx) Find() (result []*domain.BasketProduct, err error) {
	return result, a.tx.Find(&result)
}

func (a productHasManyBasketProductTx) Append(values ...*domain.BasketProduct) (err error) {
...
func (a productHasManyBasketProductTx) Replace(values ...*domain.BasketProduct) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a productHasManyBasketProductTx) Delete(values ...*domain.BasketProduct) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a productHasManyBasketProductTx) Clear() error {
	return a.tx.Clear()
}

func (a productHasManyBasketProductTx) Count() int64 {
	return a.tx.Count()
}

type productHasManyPromotionProduct struct {
	db *gorm.DB

	field.RelationField
}

func (a productHasManyPromotionProduct) Where(conds ...field.Expr) *productHasManyPromotionProduct {
	if len(conds) == 0 {
		return &a
	}
...
func (a productHasManyPromotionProduct) WithContext(ctx context.Context) *productHasManyPromotionProduct {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a productHasManyPromotionProduct) Session(session *gorm.Session) *productHasManyPromotionProduct {
	a.db = a.db.Session(session)
	return &a
}

func (a productHasManyPromotionProduct) Model(m *domain.Product) *productHasManyPromotionProductTx {
	return &productHasManyPromotionProductTx{a.db.Model(m).Association(a.Name())}
}

type productHasManyPromotionProductTx struct{ tx *gorm.Association }

func (a productHasManyPromotionProductTx) Find() (result []*domain.PromotionProduct, err error) {
	return result, a.tx.Find(&result)
}

func (a productHasManyPromotionProductTx) Append(values ...*domain.PromotionProduct) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a productHasManyPromotionProductTx) Replace(values ...*domain.PromotionProduct) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a productHasManyPromotionProductTx) Delete(values ...*domain.PromotionProduct) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a productHasManyPromotionProductTx) Clear() error {
	return a.tx.Clear()
}

func (a productHasManyPromotionProductTx) Count() int64 {
	return a.tx.Count()
}
...
type IProductDo interface {
	...
	Unscoped() IProductDo
	Create(values ...*domain.Product) error
	CreateInBatches(values []*domain.Product, batchSize int) error
	Save(values ...*domain.Product) error
	First() (*domain.Product, error)
	Take() (*domain.Product, error)
	Last() (*domain.Product, error)
	Find() ([]*domain.Product, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Product, err error)
	FindInBatches(result *[]*domain.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*domain.Product) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*domain.Product, error)
	FirstOrCreate() (*domain.Product, error)
	FindByPage(offset int, limit int) (result []*domain.Product, count int64, err error)
...
func (p productDo) Create(values ...*domain.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) CreateInBatches(values []*domain.Product, batchSize int) error {
	return p.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (p productDo) Save(values ...*domain.Product) error {
	if len(values) == 0 {
		return nil
	}
...
func (p productDo) First() (*domain.Product, error) {
...
func (p productDo) Take() (*domain.Product, error) {
...
func (p productDo) Last() (*domain.Product, error) {
...
func (p productDo) Find() ([]*domain.Product, error) {
	result, err := p.DO.Find()
	return result.([]*domain.Product), err
}

func (p productDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*domain.Product, err error) {
	buf := make([]*domain.Product, 0, batchSize)
...
func (p productDo) FindInBatches(result *[]*domain.Product, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (p productDo) FirstOrInit() (*domain.Product, error) {
...
func (p productDo) FirstOrCreate() (*domain.Product, error) {
...
func (p productDo) FindByPage(offset int, limit int) (result []*domain.Product, count int64, err error) {
...
func (p productDo) Delete(models ...*domain.Product) (result gen.ResultInfo, err error) {
