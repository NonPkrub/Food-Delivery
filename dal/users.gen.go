...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.NationalID = field.NewString(tableName, "national_id")
	_user.Address = field.NewString(tableName, "address")
	_user.DetailAddress = field.NewString(tableName, "detail_address")
...
func (u *user) updateTableName(table string) *user {
	...
	u.NationalID = field.NewString(table, "national_id")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["national_id"] = u.NationalID
